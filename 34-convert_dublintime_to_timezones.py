...
time_str = input("Enter the time in Dublin (YYYY-MM-DD HH:MM:SS): ")
from_timezone = "Europe/Dublin"  # Source timezone
to_timezones = ["Pacific/Auckland", "Asia/Kolkata", "Europe/Madrid", "America/New_York", "America/Los_Angeles"]  # Target timezones

print(time_str, "in Dublin, Ireland converts to:")
print()
