...
for region in all_regions:
    ...
    for volume in unattached_volumes:
        if 'Tags' in volume:
            ...
            print(f"Volume ID: {volume['VolumeId']} : Size (GiB): {volume['Size']} : AZ: {volume['AvailabilityZone']} : Type: {volume['VolumeType']} : Created: {volume['CreateTime']} : Tags: {tag_string}")

        else:
            print(f"Volume ID: {volume['VolumeId']} : Size (GiB): {volume['Size']} : AZ: {volume['AvailabilityZone']} : Type: {volume['VolumeType']} : Created: {volume['CreateTime']} : Tags: None")
